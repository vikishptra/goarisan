...
func (r *ginController) sendemailconfirmHandler() gin.HandlerFunc {

	type InportRequest = sendemailconfirm.InportRequest
	type InportResponse = sendemailconfirm.InportResponse
