...
func (r *ginController) runupdateusermoneyHandler() gin.HandlerFunc {

	type InportRequest = runupdateusermoney.InportRequest
	type InportResponse = runupdateusermoney.InportResponse
